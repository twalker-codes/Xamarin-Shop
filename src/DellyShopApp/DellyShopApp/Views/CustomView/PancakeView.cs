...
namespace DellyShopApp.Views.CustomView
{
    public class PancakeView : ContentView
    {
        ...
        public static readonly BindableProperty BackgroundGradientStopsProperty = BindableProperty.Create(nameof(BackgroundGradientStops), typeof(DellyShopApp.Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(DellyShopApp.Styles.GradientStopCollection),
        defaultValueCreator: bindable =>
        {
            return new DellyShopApp.Styles.GradientStopCollection();
        });
        ...
        public static readonly BindableProperty BorderGradientStopsProperty = BindableProperty.Create(nameof(BorderGradientStops), typeof(DellyShopApp.Styles.GradientStopCollection), typeof(PancakeView), defaultValue: default(DellyShopApp.Styles.GradientStopCollection),
        defaultValueCreator: bindable =>
        {
            return new DellyShopApp.Styles.GradientStopCollection();
        });
        ...
        public DellyShopApp.Styles.GradientStopCollection BackgroundGradientStops
        {
            get { return (DellyShopApp.Styles.GradientStopCollection)GetValue(BackgroundGradientStopsProperty); }
        ...
        public DellyShopApp.Styles.GradientStopCollection BorderGradientStops
        {
            get { return (DellyShopApp.Styles.GradientStopCollection)GetValue(BorderGradientStopsProperty); }
