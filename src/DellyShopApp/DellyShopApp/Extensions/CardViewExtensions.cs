...
namespace DellyShopApp.Extensions
{
    public static class CardViewExtensions
    {
        ...
        public static DellyShopApp.Views.CustomView.CarouselView AsCarouselView(this BindableObject bindable)
        => bindable as DellyShopApp.Views.CustomView.CarouselView;
